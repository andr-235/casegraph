...
fn seed_settings(conn: &Connection) -> Result<(), AppErrorDto> {
    let settings = [
        ...
        (
            ...
            "string",
            "docx",
            "Папка экспорта DOCX по умолчанию",
        ),
        (
            ...
            "boolean",
            "docx",
            "Включать таблицу материалов в DOCX",
        ),
        (
            ...
            "boolean",
            "docx",
            "Включать таблицу SHA-256 в DOCX",
        ),
        (
            "backup.default_dir",
            "",
            "string",
            "backup",
            "Папка резервного копирования по умолчанию",
        ),
        (
            ...
            "boolean",
            "backup",
            "Создавать бэкап безопасности перед восстановлением",
        ),
        (
            ...
            "boolean",
            "backup",
            "Проверять бэкап после создания",
        ),
        (
            ...
            "boolean",
            "integrity",
            "Предупреждать перед экспортом DOCX",
        ),
        (
            ...
            "boolean",
            "integrity",
            "Предупреждать перед резервным копированием",
        ),
        (
